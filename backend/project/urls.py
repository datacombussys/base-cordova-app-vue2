...
router.register(r'django/inventory-gallery', InvGalleryViewset)
router.register(r'django/invcategory-class', InvCategoryClassViewset)
router.register(r'django/inventory-category', InvCategoryViewset)
