<template>
    <f7-page name="attendance-reports">
       <f7-navbar back-link="Back">
        ...
        <f7-nav-title>Attendance Reports</f7-nav-title>
        <f7-nav-right>
          ...
          <f7-row class="full-width">
            ...
            <f7-col width="50" class="display-flex flex-direction-column padding">
              <f7-row class="full-width display-flex justify-content-center">
                <f7-block-title>Consolidated Time Cards</f7-block-title>
                <f7-col>
                  <p>I need to be able to attach a attendance Shift to an emloyee</p>
