<template>
	<div>
		<popup-component :popupSettings="popupSettings">
			<span slot="title">Create Shift</span>
			<div slot="slotContent">
				<f7-block>
					<f7-card>
						<f7-card-header>
							<f7-block-title medium class="margin-top no-margin-bottom no-padding-bottom padding-left">Add Shifts</f7-block-title>
							</f7-card-header>
							<f7-list>
								<f7-card-content>
									<f7-row>
...
//Components
import f7PopupComponent from "@/components/layout-elements/popup-component.vue";

export default {
	name: "shiftPopupComponent",
	components: {
		"popup-component": f7PopupComponent
	},
	mixins: [
		UniversalMixins,
