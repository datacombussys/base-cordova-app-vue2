	...
	methods: {
		...
		syncWithMixin(payload) {
			...
			return new Promise((resolve, reject) => {
				this.companyForm.primary_mailing_country = payload.primary_country_name;
				this.companyForm.primary_mailing_state = payload.primary_state_name;
				this.companyForm.billing_country = payload.billing_country_name;
				this.companyForm.billing_state = payload.billing_state_name;
				this.companyForm.shipping_country = payload.shipping_country_name;
				this.companyForm.shipping_state = payload.shipping_state_name;
				console.log('this.companyForm', this.companyForm);
