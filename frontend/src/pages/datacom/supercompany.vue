<template>
	<f7-page name="datacom-superuser">
		...
		<f7-sheet
			class="company-image image-sheet"
			:opened="companyImageSheet"
			@sheet:closed="companyImageSheet = false"
		>
			<f7-toolbar>
				<div class="left"></div>
				<div class="right">
			...
			<f7-page-content class="padding-bottom">
				<section>
					<f7-block v-show="!datacomForm.id">
						<f7-block-header>You must first select a company to add a profile image</f7-block-header>
					</f7-block>
				</section>
