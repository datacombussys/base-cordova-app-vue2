					...
					<template>
						...
						<div class="container">
							...
							<div class="row justify-around">
								<div class="sm:col-12 lg:col-50p">
									<div class="row">
...
export default {
	...
	methods: {
		...
		submitOpenTill() {
			...
			this.totalOpenAmount = this.calcCoins() + this.calcDollars()
			console.log("this.totalOpenAmount", this.totalOpenAmount);
			this.$emit("total-open", this.totalOpenAmount)
			this.$parent.saveTillToStore()
			this.closeSheet()
			this.$parent.isTillOpen = true
		},
		cancelOpenTill() {
