				...
				<f7-list v-show="!accountSettings.editProfile">
					...
					<f7-row v-if="moduleInfo.level >= 1 && Auth.authLevel === 1" class="margin-top">
						<f7-col width="50">
							<p>Datacom:</p>
							<f7-list-item>
								<f7-toggle :checked="accountSettings.accountPlatform.is_datacom" disabled></f7-toggle>
							</f7-list-item>
						</f7-col>
						<f7-col width="50">
							<p>Company Name:</p>
							<f7-list-item v-if="accountSettings.accountPlatform.is_datacom" :title="accountSettings.accountPlatform.company_name">
								<f7-icon slot="media" size="40" icon="mdi mdi-office-building"></f7-icon>
							</f7-list-item>
							<f7-list-item v-if="!accountSettings.accountPlatform.is_datacom" title="Not Selected">
								<f7-icon slot="media" size="40" icon="mdi mdi-office-building"></f7-icon>
							</f7-list-item>
						</f7-col>
					</f7-row>
					<f7-row v-if="moduleInfo.level >= 2 && Auth.authLevel === 1" class="margin-top">
						<f7-col width="50">
							<p>Partner:</p>
							<f7-list-item>
								<f7-toggle :checked="accountSettings.accountPlatform.is_partner" disabled></f7-toggle>
							</f7-list-item>
						</f7-col>
						<f7-col width="50">
							<p>Partner Name:</p>
							<f7-list-item v-if="accountSettings.accountPlatform.is_partner" :title="accountSettings.accountPlatform.company_name">
								<f7-icon slot="media" size="40" icon="mdi mdi-office-building"></f7-icon>
							</f7-list-item>
							<f7-list-item v-if="!accountSettings.accountPlatform.is_partner" title="Not Selected">
								<f7-icon slot="media" size="40" icon="mdi mdi-office-building"></f7-icon>
							</f7-list-item>
						</f7-col>
					</f7-row>
					<f7-row v-if="moduleInfo.level >= 3 && Auth.authLevel < 3" class="margin-top">
						<f7-col width="50">
							<p>Merchant:</p>
							<f7-list-item>
								<f7-toggle :checked="accountSettings.accountPlatform.is_merchant" disabled></f7-toggle>
							</f7-list-item>
						</f7-col>
						<f7-col width="50">
							<p>Merchant Name:</p>
							<f7-list-item v-if="accountSettings.accountPlatform.is_merchant" :title="accountSettings.accountPlatform.company_name">
								<f7-icon slot="media" size="40" icon="mdi mdi-office-building"></f7-icon>
							</f7-list-item>
							<f7-list-item v-if="!accountSettings.accountPlatform.is_merchant" title="Not Selected">
								<f7-icon slot="media" size="40" icon="mdi mdi-office-building"></f7-icon>
							</f7-list-item>
						</f7-col>
					</f7-row>
					...
					<!-- <f7-row v-if="moduleInfo.level >= 4 && Auth.authLevel < 4" class="margin-top">
						<f7-col width="50">
							<p>Vendor:</p>
							<f7-list-item>
								<f7-toggle :checked="accountSettings.accountPlatform.is_vendor" disabled></f7-toggle>
							</f7-list-item>
						</f7-col>
						<f7-col width="50">
							<p>Vendor Name:</p>
							<f7-list-item v-if="accountSettings.accountPlatform.is_vendor" :title="accountSettings.accountPlatform.company_name">
								<f7-icon slot="media" size="40" icon="mdi mdi-office-building"></f7-icon>
							</f7-list-item>
							<f7-list-item v-if="!accountSettings.accountPlatform.is_vendor" title="Not Selected">
								<f7-icon slot="media" size="40" icon="mdi mdi-office-building"></f7-icon>
							</f7-list-item>
						</f7-col>
					</f7-row> -->
				...
				<f7-list v-show="accountSettings.editProfile">
					...
					<f7-row class="margin-top" v-if="moduleInfo.level >= 1 && Auth.authLevel === 1">
						<f7-col width="50">
							...
							<f7-list-item>
								<f7-toggle
									...
									:checked="accountSettings.accountPlatform.is_datacom"
						...
						<f7-col width="50">
							...
							<f7-list-input
								...
								:value="accountSettings.accountPlatform.company_name"
								@input="accountSettings.accountPlatform.company_name = $event.target.value"
								type="select"
								class="datacom-input"
							>
						...
						<f7-col width="50">
							...
							<f7-list-item>
								<f7-toggle
									...
									:checked="accountSettings.accountPlatform.is_partner"
									@change="companyTypeToggle"
								></f7-toggle>
							</f7-list-item>
						</f7-col>
					...
					<f7-row class="margin-top" v-if="moduleInfo.level >= 3 && Auth.authLevel < 3">
						<f7-col width="50">
							...
							<f7-list-item>
								<f7-toggle
									...
									:checked="accountSettings.accountPlatform.is_merchant"
									@change="companyTypeToggle"
								></f7-toggle>
							</f7-list-item>
						</f7-col>
						<f7-col width="50">
							...
							<f7-list-input
								...
								class="datacom-input"
							>
								<option v-for="co in GET_MERCHANT_LIST" :key="co.id">{{ co.dba_name }}</option>
							</f7-list-input>
						</f7-col>
					</f7-row>
					<!-- <f7-row class="margin-top" v-if="moduleInfo.level >= 4 && Auth.authLevel < 4">
						<f7-col width="50">
							...
							<f7-list-item>
								<f7-toggle
									...
									:checked="accountSettings.accountPlatform.is_vendor"
									@change="companyTypeToggle"
								></f7-toggle>
							</f7-list-item>
						</f7-col>
						<f7-col width="50">
							<p>Vendor Name:</p>
							<f7-list-input
								:disabled="accountSettings.accountPlatform.is_vendor === false"
								:value="
									Auth.platformInfo.platform === 'vendor' && Auth.isAuthenticated ? accountSettings.accountPlatform.company_name : ''
								"
								@input="accountSettings.accountPlatform.company_name = $event.target.value"
								type="select"
								class="datacom-input"
					...
					<f7-block class="full-width" v-if="!accountSettings.hideSaveItem">
						<f7-row class="margin-top level-right">
							<f7-col width="25">
								<f7-button fill @click="accountSettings.activeTab = 1" class="bg-color-deeporange">Next -></f7-button>
							</f7-col>
						</f7-row>
					</f7-block>
				</f7-list>
