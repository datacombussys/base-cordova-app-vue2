...
export default {
	...
	computed: {
		...
		...mapGetters(["GET_RECEIPT_LIST", "GET_RECEIPT_LIST_LENGTH"])
	},
	created() {
		this.tableData.list = this.GET_RECEIPT_LIST;
		this.paginatedList = this.GET_RECEIPT_LIST_LENGTH;
		console.log("created this.GET_RECEIPT_LIST", this.GET_RECEIPT_LIST);
	},
	mounted() {}
};
</script>
